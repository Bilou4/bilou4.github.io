---
layout: post
title:  "Write-Up - Over The Wire - Bandit"
description: My WU of the Bandit wargame from overthewire. The Bandit wargame is aimed at absolute beginners. It will teach the basics needed to be able to play other wargames.
author: Bilou4
tags: write-up security easy
---
...
![bandit26](/assets/2020-04-11-over-the-wire-bandit/bandit26.png)


We do the same thing again but reduce the size of our terminal so that the `more` command is effective.

![bandit26_more](/assets/2020-04-11-over-the-wire-bandit/bandit26_more.png)
